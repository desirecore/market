...
Updates and uninstallation preserve exact source/device identity, compare the last record revision, and use the original management guide. Software changes and recording are separate outcomes; recording failures do not replay installation commands. No internal services are derived. Deleting user credentials or data requires separate consent. Use the Registry's currently authorized install.md rather than stale chat instructions.
